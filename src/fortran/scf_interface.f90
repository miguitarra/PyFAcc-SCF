subroutine run_scf_interface_py(natoms, nelectrons, atomic_numbers, coords, eps_scf, max_iter, final_energy, nbasis_atom, basis_exp, basis_set) bind(C, name="run_scf_interface_py")
    use scf_module
    use molecule_module
    use slater
    use iso_c_binding
    ...
    ! Initialize molecule
    call init_molecule(mol, natoms, nelectrons, atomic_numbers, coords, nbasis_atom, basis_exp)
